...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言id</td><td>留言标题</td><td>留言时间</td><td>管理回复</td><td>回复时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="leavewordDelete('<%=leaveword.getLeaveWordId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="leavewordQueryForm" id="leavewordQueryForm" action="<%=basePath %>Leaveword/userFrontlist" class="mar_t15">
