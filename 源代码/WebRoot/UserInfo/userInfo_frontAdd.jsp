...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">志愿者管理</a></li>
  			<li class="active">添加志愿者</li>
		</ul>
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="userInfo_user_name" class="col-md-2 text-right">志愿者名:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="userInfo_user_name" name="userInfo.user_name" class="form-control" placeholder="请输入志愿者名">
					 </div>
				  </div> 
				  <div class="form-group">
				  	 <label for="userInfo_password" class="col-md-2 text-right">登录密码:</label>
				  	 <div class="col-md-8">
					    <input type="password" id="userInfo_password" name="userInfo.password" class="form-control" placeholder="请输入登录密码">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_userPhoto" class="col-md-2 text-right">志愿者照片:</label>
				  	 <div class="col-md-8">
		          ...
		          <div class="form-group">
		             ...
		             <span onclick="ajaxUserInfoAdd();" class="btn btn-primary bottom5 top5">志愿者注册</span>
		          </div> 
