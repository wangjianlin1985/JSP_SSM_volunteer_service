...
<%
    ...
    String title = (String)request.getAttribute("title"); //项目主题查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>ActivityInfo/frontlist">志愿项目信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>ActivityInfo/activityInfo_frontAdd.jsp" style="display:none;">添加志愿项目</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<activityInfoList.size();i++) {
            		...
            		ActivityInfo activityInfo = activityInfoList.get(i); //获取到志愿项目对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>ActivityInfo/<%=activityInfo.getActivityId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=activityInfo.getActivityPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		项目id:<%=activityInfo.getActivityId() %>
			     	</div>
			     	<div class="field">
	            		项目类型:<%=activityInfo.getTypeObj().getTypeName() %>
			     	</div>
			     	<div class="field">
	            		项目主题:<%=activityInfo.getTitle() %>
			     	</div>
			     	<div class="field">
	            		项目时间:<%=activityInfo.getActivityTime() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="activityInfoQueryForm" id="activityInfoQueryForm" action="<%=basePath %>ActivityInfo/frontlist" class="mar_t15">
            <div class="form-group">
            	<label for="typeObj_typeId">项目类型：</label>
			...
			<div class="form-group">
				...
				<input type="text" id="title" name="title" value="<%=title %>" class="form-control" placeholder="请输入项目主题">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;志愿项目信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="activityInfo_activityId_edit" class="col-md-3 text-right">项目id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="activityInfo_activityId_edit" name="activityInfo.activityId" class="form-control" placeholder="请输入项目id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="activityInfo_typeObj_typeId_edit" class="col-md-3 text-right">项目类型:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="activityInfo_title_edit" class="col-md-3 text-right">项目主题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="activityInfo_title_edit" name="activityInfo.title" class="form-control" placeholder="请输入项目主题">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="activityInfo_activityPhoto_edit" class="col-md-3 text-right">项目图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="activityInfo_content_edit" class="col-md-3 text-right">项目内容:</label>
		  	 <div class="col-md-9">
			 	<textarea name="activityInfo.content" id="activityInfo_content_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="activityInfo_activityTime_edit" class="col-md-3 text-right">项目时间:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="activityInfo_activityTime_edit" name="activityInfo.activityTime" class="form-control" placeholder="请输入项目时间">
			 </div>
		  </div>
		</form> 
...
<script>
//实例化编辑器
var activityInfo_content_edit = UE.getEditor('activityInfo_content_edit'); //项目内容编辑器
