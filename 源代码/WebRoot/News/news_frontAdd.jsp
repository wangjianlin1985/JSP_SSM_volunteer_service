		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>News/frontlist">新闻信息列表</a></li>
			    	<li role="presentation" class="active"><a href="#newsAdd" aria-controls="newsAdd" role="tab" data-toggle="tab">添加新闻信息</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="newsAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="news_title" class="col-md-2 text-right">新闻标题:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="news_title" name="news.title" class="form-control" placeholder="请输入新闻标题">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="news_newClass" class="col-md-2 text-right">新闻分类:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="news_newClass" name="news.newClass" class="form-control" placeholder="请输入新闻分类">
							 </div>
						  </div>
						  <div class="form-group">
