...
-- ----------------------------
INSERT INTO `t_activityinfo` VALUES ('1', '1', '周末一起去扫马路', 'upload/58ce0ab0-fd35-42c0-8a6b-a2cddeb46313.jpg', '<p>老人院附近的马路太脏了，大家一起去搞卫生吧！</p>', '2018-11-24下午3点');
INSERT INTO `t_activityinfo` VALUES ('2', '2', '一起去养老院看望老人', 'upload/df4f8b11-d3f1-4d1a-9a95-587d8d6b4951.jpg', '<p>老人们需要关爱，等这2周抽个空时间一起去看望老人，带好吃的给他们！</p>', '2018年11月20日');
...
-- ----------------------------
INSERT INTO `t_donation` VALUES ('1', 'user1', '200', '2018-11-15 16:20:08', '我用我支付宝打的，我的支付宝账号是dashen@126.com', '已审核');
INSERT INTO `t_donation` VALUES ('2', 'user2', '100', '2018-11-15 18:07:24', '我也要为公益做点贡献，已经通过支付宝转账，管理员审核下', '待审核');
INSERT INTO `t_donation` VALUES ('3', 'user1', '500', '2018-11-15 14:33:09', '给予山区的儿童关爱', '已审核');
...
-- ----------------------------
INSERT INTO `t_leaveword` VALUES ('1', '找到组织了', '以后我有发言地了哦', 'user1', '2018-11-15 16:32:25', '对的', '2018-11-16 16:32:30');
INSERT INTO `t_leaveword` VALUES ('2', '我想要要参加公益活动方便了', '这个网站不错哦，使用它可以看到我感兴趣的公益活动', 'user2', '2018-11-15 18:18:01', '--', '--');
...
-- Records of t_news
-- ----------------------------
INSERT INTO `t_news` VALUES ('1', '都需要爱护环境', '环境保护', '<p>全世界人民团结起来，一起爱护咱们的地球环境！</p>', '2018-11-15 16:33:05');
INSERT INTO `t_news` VALUES ('2', '关于义工服务', '义工服务', '<p>义工服务要认真</p>', '2018-11-15 16:33:33');
INSERT INTO `t_news` VALUES ('3', '关爱留守儿童', '公益资讯', '<p>中国留守儿童和老人太多了，希望大家多关心下它们</p>', '2018-11-15 16:33:54');
...
CREATE TABLE `t_organize` (
  `organizeId` int(11) NOT NULL auto_increment COMMENT '组织id',
  `organizeName` varchar(20) NOT NULL COMMENT '组织名称',
  `organizePhoto` varchar(60) NOT NULL COMMENT '组织照片',
  `makeDate` varchar(20) default NULL COMMENT '成立日期',
  `fuzheren` varchar(20) NOT NULL COMMENT '联系负责人',
  `telephone` varchar(20) NOT NULL COMMENT '报名电话',
  `organizeDesc` varchar(8000) NOT NULL COMMENT '组织介绍',
  `signUpNames` varchar(1000) NOT NULL COMMENT '已报名人员',
  PRIMARY KEY  (`organizeId`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_organize
-- ----------------------------
INSERT INTO `t_organize` VALUES ('1', '成都理工大志愿队', 'upload/c49977d9-7b50-4deb-b80d-d98abe30177d.jpg', '2018-11-08', '王忠强', '028-89382934', '<p>本组织主要是汇集有爱心的同学们，利用你们的空闲时间去福利院照顾贫困老人！</p>', '小明，小英');
INSERT INTO `t_organize` VALUES ('2', '成理计科卫生志愿队', 'upload/e38caf2e-a395-4760-a085-020c1a92f809.jpg', '2018-11-01', '李明月', '13989308342', '<p>本志愿队负责关注维护城市感觉舒适的环境<br/></p>', '王群华，李明英');
...
-- Records of t_signup
-- ----------------------------
INSERT INTO `t_signup` VALUES ('1', '1', 'user1', '爱护环境 从我做起！', '2018-11-15 16:19:59');
INSERT INTO `t_signup` VALUES ('2', '1', 'user2', '小女子也喜欢爱护环境哦！', '2018-11-15 17:38:19');
...
-- ----------------------------
INSERT INTO `t_userinfo` VALUES ('user1', '123', '双鱼林', '男', '2018-01-02', 'upload/9bd20c2f-9c36-4966-bb8e-431ce903ac5f.jpg', '13573598343', 'dashen@163.com', '四川成都红星路13号', '2018-11-15 16:14:42');
INSERT INTO `t_userinfo` VALUES ('user2', '123', '李晓霞', '女', '2018-01-04', 'upload/bf95e49b-be94-4b5e-b4b6-720bbc9cee62.jpg', '15129893233', 'xiaoxia@163.com', '福建福州滨海路', '2018-11-15 17:37:32');
